...
/**
 * Gap/CFS Feature Page: No encryption or security audit module.
 * Slug: no-encryption-or-security-audit-module
 * Backend: /api/gap-no-encryption-or-security-audit-module
 */
export default function NoEncryptionOrSecurityAuditModulePage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-encryption-or-security-audit-module', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>No encryption or security audit module.</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>No encryption or security audit module.</p>
