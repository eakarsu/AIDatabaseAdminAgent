...
/**
 * Gap/CFS Feature Page: No notification system.
 * Slug: no-notification-system
 * Backend: /api/gap-no-notification-system
 */
export default function NoNotificationSystemPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-notification-system', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>No notification system.</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>No notification system.</p>
