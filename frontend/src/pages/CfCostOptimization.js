...
/**
 * Gap/CFS Feature Page: Cost optimization
 * Slug: cost-optimization
 * Backend: /api/cf-cost-optimization
 */
export default function CostOptimizationPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/cf-cost-optimization', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>Cost optimization</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>Recommend instance sizing and storage optimization for cloud databases.</p>
